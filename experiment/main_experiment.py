...
if __name__ == '__main__':
    ...
    if partition != 'default':
        ...
        for i in range(10, 50, 10): #lnsvidim128-lambda100-lr0.0001_RegionDCL20_40.pkl
            test_paths[f'RegionDCL-{i}'] = f'embeddings/{city}/moesvi_dim64-lambda100-lr0.0001-svi_drop0.1-bndrop0.2-r100-seed3407_RegionDCL20_{i}.pkl'
        test_paths['RegionDCL-Best'] = f'embeddings/{city}/moesvi_dim64-lambda100-lr0.0001-svi_drop0.1-bndrop0.2-r100-seed3407_RegionDCL20_best.pkl'
